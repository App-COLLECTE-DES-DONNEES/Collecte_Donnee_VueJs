/*!
  * vue-keycloak-js v1.3.1
  * @license ISC
  */
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
  typeof define === 'function' && define.amd ? define(factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global['dsb-vue-keycloak'] = factory());
  ...
  function init(config, watch, options) {
    ...
    keycloak$1.onReady = function (authenticated) {
      ...
      watch.ready = true;
      typeof options.onReady === 'function' && options.onReady(keycloak$1);
    };
    ...
    keycloak$1.onAuthSuccess = function () {
      ...
      var updateTokenInterval = setInterval(function () {
        return keycloak$1.updateToken(60).catch(function () {
    ...
    keycloak$1.onAuthRefreshError = function () {
      ...
      typeof options.onAuthRefreshError === 'function' && options.onAuthRefreshError(keycloak$1);
    };

    keycloak$1.init(options.init).then(function (authenticated) {
      updateWatchVariables(authenticated);
      typeof options.onInitSuccess === 'function' && options.onInitSuccess(authenticated);
    }).catch(function () {
      // Keycloak does not return any error message
      updateWatchVariables(false);
      var error = Error('Could not initialized keycloak-js adapter');
  ...
  function assertOptions(options) {
    var config = options.config,
        ...
        onAuthRefreshError = options.onAuthRefreshError;
    ...
    if (onAuthRefreshError && typeof onAuthRefreshError !== 'function') {
      return {
        hasError: true,
        error: "'onAuthRefreshError' option must be a function. Found: '".concat(onAuthRefreshError, "'")
      };
    }
  ...
  function sanitizeConfig(config) {
    var renameProp = function renameProp(oldProp, newProp, _ref) {
      ...
      return _objectSpread2(_defineProperty({}, newProp, old), others);
    };
